...
#define CURRENT_FPGA_VCCIO 6
#define CURRENT_SRAM 7
#define CURRENT_DAUGHTER 8

// dictate where to find every channel
#define CURRENT_USB_ADDRESS 0b01001101
#define CURRENT_USB_CHANNEL 2
...
#define CURRENT_DAUGHTER_ADDRESS 0b00101001
#define CURRENT_DAUGHTER_CHANNEL 1
#define CURRENT_DAUGHTER_R 0.8f
...
#define CURRENT_FPGA_VCCIO_ADDRESS 0b01001111
#define CURRENT_FPGA_VCCIO_CHANNEL 2
#define CURRENT_FPGA_VCCIO_R 0.8f
#define CURRENT_FPGA_SRAM_ADDRESS 0b01001111
#define CURRENT_FPGA_SRAM_CHANNEL 1
#define CURRENT_FPGA_SRAM_R 0.8f
...
#define CURRENT_SAMPLING_CONFIG 0b011 	// Measurement accuracy :
// 80 	101 2047	12
// 40	100 1023	11
// 20	011 511		10
// 10 	010 255		9
